...
$(document).ready(function(){
 ...
 //성별 속성 추가하기    
 var gender = '${kakaouserInfo.gender}';
...
<input type="hidden" value="${kakaouserInfo.id}" name="uuid">
...
<input type="email" id="email" name="email" value="${kakaouserInfo.email}" class="form-control mtemail" onblur="emailchk()">
