...
<form action="/member/findpw" method="post" onsubmit="return findpwcheck()">
...
<input type="text" id="id" name="id" class="form-control" style="width: 292.83px;">

<label for="phone" style="font-weight: bold; margin-top: 4px;">휴대폰번호</label>
...
<input id="phone_certify" name="phone_certify" class="form-control" disabled="disabled" style="width:300px;margin-right: 10px; margin-top: 7px;"> 
<input type="button" id="phoneChk2" class="button" value="인증하기" style="margin-top: 7px;"> 
</div>
<span class="successPhoneChk" style="font-size: 14px;">※ 휴대폰 번호는 '-' 없이 번호만 입력하세요.</span> 
...
<c:if test="${findpwok == 'normalmember' }">
<form action="/member/newpw" method="post" onsubmit="return findpw()">
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
<div class="col-lg-3 container" id="ys_findidform">
<div align="center">
  <h2><span class="ys_findidfont">비밀번호 찾기</span></h2>
