...
<form action="/member/mentorfindpw" method="post" onsubmit="return findidcheck()">
...
<c:if test="${findpwok == 'normalmentor' }">
<form action="/member/mentornewpw" method="post" onsubmit="return findpwcheck()">
<div class="col-lg-3 container" id="ys_findidform">
<div align="center">
  <h2><span class="ys_findidfont">비밀번호 찾기</span></h2>
</div>
