	...
	<%@ include file="../public/header.jsp"%>
			...
			<div class="col-lg-8 container">
				...
				<div class="hjmain">
					...
					<form method="post" action="mentorUpdatePw_ok" onsubmit="return check()">
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
						...
						<br><br><br>
						<div align="center">
							<span> <input type="button" id="join_submit" value="취소" class="hjresetBtn" onClick="location.href='main'"/>
							<span> <input type="submit" id="join_submit" value="수정" class="hjsubmitBtn" />
							</span>
						</div>
					</form>
				</div>
